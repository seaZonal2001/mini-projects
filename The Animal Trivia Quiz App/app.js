...
// These are just for practice ,we could have used APIs for fecthing questions.
const questions = [
    {
        question : 'How many different sounds a cat can make?',
...
function renderScore(){
    ...
    scoreContainer.innerHTML += `<h2>Number if correctly answered questions : ${score}</h2>`;
}